...
def round_scores(student_scores):
    ...
    """
    rounded_scores = [round(iter) for iter in student_scores]
...
def count_failed_students(student_scores):
    ...
    """
    failed_students = [mark for mark in student_scores if mark <= 40]
...
def above_threshold(student_scores, threshold):
    ...
    """
    best_score = [mark for mark in student_scores if mark>= threshold]
    return best_score
...
def letter_grades(highest):
    ...
    grade=[iter for iter in range(41,highest,interval)]
    return grade
...
def student_ranking(student_scores, student_names):
    ...
    """
    ranking=[f'{index}. {name}: {score}' for index, (name, score) in enumerate(zip(student_names,student_scores), start=1)]
    return ranking
