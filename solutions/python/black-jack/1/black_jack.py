...
def higher_card(card_one, card_two):
    ...
    """
    card_val1 = value_of_card(card_one)
    card_val2 = value_of_card(card_two)
...
def is_blackjack(card_one, card_two):
    ...
    """
    sum_of_cards = 0
    for i in [card_one,card_two]:
        if i=='A':
            sum_of_cards += 11
        else:
            sum_of_cards += value_of_card(i)
    if sum_of_cards==21:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    card_val1 = value_of_card(card_one)
    card_val2 = value_of_card(card_two)
    if card_val1 + card_val2 in [9,10,11]:
        return True
    return False
